...
public class Main extends javax.swing.JFrame {
    ...
    database datadatabase = new database();
    List dataKegiatan = datadatabase.readKegiatan();
    List dataMahasiswa = datadatabase.readMahasiswa();
...
//            List dataKegiatan = datadatabase.readKegiatan();
    ...
    private void initComponents() {
        ...
        jScrollPane2.setBounds(20, 160, 480, 402);
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        ...
        else if (strAlamat == null || strAlamat.isEmpty())
        {
            ...
            try {
                database.writeMahasiswa(dataBaru);
            } catch (Exception ex) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (strKegiatan == null || strKegiatan.isEmpty())
        {
            ...
            try {
                database.writeKegiatan(dataBaru);
            } catch (Exception ex) {
                Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            try {
                dataKegiatan = datadatabase.readKegiatan();
